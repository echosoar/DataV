...
let exportPage = (dirname, data, cb) => {
  ...
  fs.writeFileSync(path.join(dirname, '/libs/ReactRouter.js'), fs.readFileSync(path.join(__dirname, 'lib/ReactRouter.js')).toString());
...
<script src="./libs/ReactRouter.js"></script>
